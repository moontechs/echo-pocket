...
void test_voltage_above_max_is_100(void)
{
...
void test_voltage_below_min_is_0(void)
{
...
void test_voltage_zero_is_0(void)
{
    TEST_ASSERT_EQUAL(0, battery_voltage_to_percent(0));
}

void test_voltage_negative_is_0(void)
{
    TEST_ASSERT_EQUAL(0, battery_voltage_to_percent(-500));
}

void test_voltage_table_points_match(void)
{
...
void test_voltage_interpolation_mid(void)
{
...
void test_voltage_interpolation_just_above_low_end(void)
{
...
void test_voltage_interpolation_just_below_high_end(void)
{
...
void test_voltage_monotonic_descending(void)
{
...
void test_percent_to_threshold_normal(void)
{
...
void test_percent_to_threshold_warning(void)
{
...
void test_percent_to_threshold_critical(void)
{
...
void test_percent_to_threshold_unknown(void)
{
...
void test_block_upload_critical_large_file(void)
{
...
void test_block_upload_critical_small_file(void)
{
...
void test_block_upload_warning_allowed(void)
{
...
void test_block_upload_normal_allowed(void)
{
...
void test_block_upload_unknown_allowed(void)
{
...
void test_block_upload_critical_exact_boundary(void)
{
...
void test_unknown_constant_is_negative(void)
{
    TEST_ASSERT_TRUE(BATTERY_PERCENT_UNKNOWN < 0);
}

void test_low_upload_max_is_reasonable(void)
{
...
void test_full_pipeline_high_battery(void)
{
...
void test_full_pipeline_warning(void)
{
...
void test_full_pipeline_critical(void)
{
