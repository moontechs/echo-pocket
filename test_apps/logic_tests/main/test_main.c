...
extern void test_mono_rb_discard_drops_backlog(void);
extern void test_mono_rb_discard_null_safe(void);
extern void test_mono_rb_discard_on_empty_is_noop(void);
...
extern void test_remove_by_state_removes_only_matching(void);
extern void test_remove_by_state_none_matching(void);
extern void test_remove_by_state_all_matching(void);
extern void test_remove_by_state_null_safety(void);
...
extern void test_audio_filename_offline_boot_id_falls_back_without_now(void);
extern void test_audio_filename_offline_boot_id_reconstructed_after_sync(void);
extern void test_audio_filename_offline_boot_id_future_uptime_falls_back(void);
...
void app_main(void)
{
    ...
    RUN_TEST(test_mono_rb_discard_drops_backlog);
    RUN_TEST(test_mono_rb_discard_null_safe);
    RUN_TEST(test_mono_rb_discard_on_empty_is_noop);
    ...
    RUN_TEST(test_remove_by_state_removes_only_matching);
    RUN_TEST(test_remove_by_state_none_matching);
    RUN_TEST(test_remove_by_state_all_matching);
    RUN_TEST(test_remove_by_state_null_safety);
    ...
    RUN_TEST(test_audio_filename_offline_boot_id_falls_back_without_now);
    RUN_TEST(test_audio_filename_offline_boot_id_reconstructed_after_sync);
    RUN_TEST(test_audio_filename_offline_boot_id_future_uptime_falls_back);
